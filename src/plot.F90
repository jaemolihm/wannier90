...
contains
  ...
  subroutine plot_main()
    ...
    if (wannier_plot .and. use_pwf_jml) call plot_wannier_pwf
...
209   format(a, '_idir', i1, '_', i5.5, '.cube')
...
208   format(a, '_idir', i1, '_', i5.5, '.xsf')
  ...
  end subroutine plot_wannier_pwf
